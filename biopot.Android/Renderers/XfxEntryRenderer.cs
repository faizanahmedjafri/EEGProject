...
using biopot.Droid.Extensions;

[assembly: ExportRenderer(typeof(XfxEntry), typeof(XfxEntryRenderer))]
namespace biopot.Droid.Renderers
{
	public class XfxEntryRenderer : FormsAppCompat.ViewRenderer<XfxEntry, TextInputLayout>,
		ITextWatcher,
		TextView.IOnEditorActionListener
	{
		...
		public XfxEntryRenderer(Context context) : base(context)
		{
			AutoPackage = false;
		}
		...
		protected virtual void DisableClipboard()
		{
			EditText.CustomSelectionActionModeCallback = new Callback();
			//EditText.CustomInsertionActionModeCallback = new Callback();
		}
		...
		public void SetFloatingHintEnabled()
		{
			...
			//Control.SetHintTextAppearance(Droid.Resource.Style.MyTextInputLayout);
			SetFontAttributesSizeAndFamily();
		}
